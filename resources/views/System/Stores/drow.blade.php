...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form id="storeForm" action="{{ route('stores.updateQuantity', $store->id) }}" method="POST"
                enctype="multipart/form-data">
                @csrf

                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label" for="quantity">الكمية المطلوبة:</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" data-quantity="{{ $store->quantity }}"
                            value="{{ $store->quantity }}" name="quantity" id="quantity_from_store" required>
            ...
            <form id="storeForm" action="{{ route('fertilizer.storeFromStore') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control" name="acquired_date" id="acquired_date_from_store" required>
                    </div>
                </div>
