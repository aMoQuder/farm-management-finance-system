                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="radio" name="type_work" id="not_from_store" value="not_store" class="mr-4"
                                    checked>
                                غير
                                المخزن
                            </div>
                        ...
                        <form id="notStoreForm" action="{{ route('fertilizerStore') }}" method="POST"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="number" class="form-control" name="quantity" id="quantity_not_store"
                                        required>
                                </div>
                            </div>
                            <div class="row mb-3">
                        ...
                        <form id="storeForm" action="{{ route('fertilizer.storeFromStore') }}" method="POST"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="number" class="form-control" name="quantity" id="quantity_from_store"
                                        required>
                                </div>
